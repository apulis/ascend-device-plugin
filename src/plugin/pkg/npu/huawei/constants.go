...
const (
    ...
    // dlts platform still depends on this var
    // must remove it later
    VISIBLE_DEVICE_IDS      = "VISIBLE_IDS"                                          // for dlts 
    NPU_IPS                 = "NPU_IPS"                                              // for dlts 

	logChmod                = 0640

	huaweiAscend910  = "npu.huawei.com/NPU"
